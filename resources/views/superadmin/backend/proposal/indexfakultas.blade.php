...
@section('tittle', 'Verifikasi Fakultas')  
                  ...
                  <div class="card">
                    <div class="card-header border-0">
                      <div class="row align-items-center">
                        <div class="col">
                          <h3 class="mb-0">Verifikasi Fakultas</h3>
                        </div>
                        ...
                        <tbody>
                            ...
                            <tr height="50px">
                                ...
                                <td class="table-actions text-center">
                                    <a href="{{ route('proposal.editfakultas', $prop->id) }}" class="table-action text-info" data-toggle="tooltip" data-original-title="Edit Ajuan Proposal">
