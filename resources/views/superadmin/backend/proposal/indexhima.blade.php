...
@section('tittle', 'Pengajuan Proposal Kegiatan')  
      ...
      <div class="header-body">
        <div class="row align-items-center py-4">
          <div class="col-lg-6 col-7">
            <h6 class="h2 text-white d-inline-block mb-0">Ajuan Proposal Kegiatan</h6>
                  ...
                  <div class="card">
                    <div class="card-header border-0">
                      <div class="row align-items-center">
                        <div class="col">
                          <h3 class="mb-0">Pengajuan Proposal Kegiatan</h3>
                        </div>
                        <div class="col text-right">
                          <a href="#" id="createproposal" class="btn btn-sm btn-primary">Create</a>
                        </div>
                      </div>
                    </div>
                      ...
                      <table id="table_proposal" class="table text-center align-items-center table-flush">
                        ...
                        <tbody>
                            ...
                            <tr height="50px">
                                ...
                                <td>
                                  @if  ($prop->status == "1")
                                    <h5 class="text-info">Proposal Di Proses Prodi</h5>
                                  @elseif ($prop->status == "2")
                                    <h5 class="text-info">Proposal Di Proses Fakultas</h5>
                                  @elseif ($prop->status == "3")
                                    <h5 class="text-success">Proposal Telah Selesai</h5>
                                  @elseif ($prop->status == "10")
                                    <h5 class="text-danger">Proposal Ditolak Prodi</h5>
                                  @elseif ($prop->status == "11")
                                    <h5 class="text-danger">Proposal Di Tolak Fakultas</h5>
                                    @endif
                                </td>
                                <td>
                                ...
                                <td class="table-actions text-center">
                                    <a href="{{ route('proposal.show', $prop->id) }}" class="table-action text-success" data-toggle="tooltip" data-original-title="Lihat Progres Proposal">
                                      <i class="fas fa-eye"></i>
                                    </a>
                                    <a href="#!" onclick="deleteRow( {{$prop->id}} )" class="table-action text-danger sa-warning" data-toggle="tooltip" data-original-title="Delete Departemen">
                                      <i class="fas fa-trash"></i>
                                      <form action="{{ route('proposal.destroy', $prop->id)}}" id="data-{{ $prop->id }}" method="POST">
                                          @csrf
                                          @method('delete')
                                      </form>
                                    </a>
    ...
    function deleteRow(id)
            {
                    swal({   
                        ...
                        text: "Proposal akan dihapus selamanya !",   
                        type: "warning",   
                        ...
                        if (res.value) {
                            ...
                            console.log('cancel');
                            swal('Delete Proposal Dibatalkan !','','warning');
                        }
                        else{
                            console.log('cancel');
                            swal('Delete Proposal Dibatalkan !','','warning');
