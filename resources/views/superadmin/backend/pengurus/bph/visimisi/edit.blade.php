        ...
        <div class="col-lg-8 card-wrapper">
          <div class="card">
              ...
              <div class="card-header">
                <h3 class="mb-0 text-center">Edit Visi & Misi</h3>
              </div>
              <!-- Card body -->
              <div class="card-body">
                  <form action="{{ route('visimisi.update', $visimisi->id )}}" method="POST">
                    @method('PUT')
                      ...
                      <div class="form-group">
                        ...
                        <textarea class="form-control" id="visi" placeholder="Enter Visi" name="visi" value="{{ old('visi') }}" rows="3">{{ $visimisi->visi }}</textarea>
                    </div>
                    @error('visi')
                    ...
                    @enderror
                      <div class="form-group">
                          ...
                          <textarea class="form-control" id="misi" placeholder="Enter misi" name="misi" value="{{ old('misi') }}" rows="3">{{ $visimisi->misi }}</textarea>
                      </div>
                      @error('misi')
                          <div class="alert alert-danger alert-dismissible fade show" role="alert">
                              <span class="alert-icon"><i class="ni ni-fat-remove"></i></span>
