        ...
        <div class="col-lg-8 card-wrapper">
          <div class="card">
              ...
              <div class="card-header">
                <h3 class="mb-0 text-center">Edit Departemen</h3>
              </div>
              <!-- Card body -->
              <div class="card-body">
                  <form action="{{ route('departemen.update', $departemen->id )}}" method="POST" >
                    ...
                    @csrf
                      ...
                      <label class="form-control-label" for="departemen">Name</label>
                          <input type="text" class="form-control" id="departemen" placeholder="Enter Name" name="departemen" value="{{ $departemen->departemen }}">
                      </div>
                      @error('departemen')
                      ...
                      <div class="form-group">
                        <label class="form-control-label" for="slug">Slug</label>
                            <input type="text" class="form-control" id="slug" placeholder="Enter Slug" name="slug" value="{{ $departemen->slug }}" readonly>
                        </div>
                        @error('slug')
                            <div class="alert alert-danger alert-dismissible fade show" role="alert">
                                <span class="alert-icon"><i class="ni ni-fat-remove"></i></span>
