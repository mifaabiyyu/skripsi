        ...
        <div class="col-lg-8 card-wrapper">
          <div class="card">
              ...
              <div class="card-header">
                <h3 class="mb-0 text-center">Add Anggota</h3>
              </div>
              <!-- Card body -->
              <div class="card-body">
                  <form action="{{ route('anggota.store')}}" method="POST" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <select name="departemen" id="departemen" class="form-control" data-toggle="select">
                          ...
                          @foreach ($departemen as $dep)
                              <option value="{{ $dep->name }}" {{ old('departemen') == $dep->name ? 'selected' : null }}>{{ $dep->name }}</option>
                          @endforeach
                        </select>
                      </div>
                      @error('departemen')
                      ...
                      <div class="form-group">
                        ...
                        <select name="jabatan" id="jabatan" class="form-control" data-toggle="select">
                            <option value="">- Pilih Jabatan -</option>
                            <option value="Kepala Departemen" {{ old('jabatan') == 'Kepala Departemen' ? 'selected' : '' }}>Kepala Departemen</option>
