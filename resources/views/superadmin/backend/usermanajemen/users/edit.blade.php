      ...
      <div class="col-lg-8 card-wrapper">
        <div class="card">
            ...
            <div class="card-header">
              <h3 class="mb-0 text-center">Edit User {{ $user->name}}</h3>
            </div>
            <!-- Card body -->
            <div class="card-body">
                <form action="{{ route('users.update', $user->id)}}" method="POST">
                    ...
                    <label class="form-control-label" for="name">Username</label>
                        <input type="text" class="form-control" id="name" placeholder="Enter Username" name="name" value="{{ $user->name }}">
                    </div>
                    @error('name')
                    ...
                    <div class="form-group">
                        <label class="form-control-label" for="exampleFormControlSelect1">Select Role</label>
