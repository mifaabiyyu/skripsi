...
<div id="content" class="no-top no-bottom">
    <section aria-label="section-services">
        <div class="container">
            <div class="row">
                <div class="col-md-8">
                    <h4 style="font-style: italic;">Hasil dari Kategori : 
                        @foreach ($hasilkategori as $kate)
                        {{ $kate->category}}
                        @endforeach
                    </h4>
                    <div class="spacer-single"></div>
                    @foreach ($kategori_berita as $berhima)
                    <div class="blog-item">
                        ...
                        <div class="text">
                            ...
                            <p>{!! Illuminate\Support\Str::limit($berhima->konten, 300) !!}
                                ...
                                <a href="{{ route('beritahima.show', $berhima->slug) }}" class="btn-link inline">Read More</a>
                                  @endif
                            </p>
                            <div class="post-meta ">
